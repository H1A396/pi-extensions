...
See [docs/phase-reference.md](https://cdn.jsdelivr.net/npm/@vigolium/piolium@0.0.13/docs/phase-reference.md) for per-phase behavior and outputs.
...
-   [HACKING.md](https://cdn.jsdelivr.net/npm/@vigolium/piolium@0.0.13/HACKING.md) - technical setup, flags, retries, release, and development notes.
-   [docs/phase-reference.md](https://cdn.jsdelivr.net/npm/@vigolium/piolium@0.0.13/docs/phase-reference.md) - phase behavior and outputs.
-   [docs/output-structure.md](https://cdn.jsdelivr.net/npm/@vigolium/piolium@0.0.13/docs/output-structure.md) - output directory layout.
